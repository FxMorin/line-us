...
(function (simplepaint) {
    ...
    var CanvasManager = (function () {
        ...
        CanvasManager.prototype.attachEvents = function () {
            ...
            var $box = this.$menu.find(".ui-box");
            var $line = this.$menu.find(".ui-line");
            var $erase = this.$menu.find(".ui-eraser");
            var $clear = this.$menu.find(".ui-clear");
        ...
        CanvasManager.prototype.buildSimplePaint = function () {
            ...
            var $b_box = $("<i class=\"icon-box\" title=\"Box\"></i>");
            var $b_line = $("<i class=\"icon-line\" title=\"Line\"></i>");
            var $b_eraser = $("<i class=\"icon-eraser\" title=\"Eraser\"></i>");
            var $b_clear = $("<i class=\"icon-clear\" title=\"Clear\"></i>");
            ...
            var $b_canvas = $("<canvas id=\"hacking\"></canvas>");
            ...
            var menuItems = [
                ...
                this.wrapMenuItem($b_box, "ui-box"),
                this.wrapMenuItem($b_line, "ui-line"),
                this.wrapMenuItem($b_eraser, "ui-eraser"),
                this.wrapMenuItem($b_clear, "ui-clear")
            ];
            if (this.canFill()) {
...
(function (simplepaint) {
    var DrawingManager = (function () {
        ...
        DrawingManager.prototype.handleMouseUp = function (event) {
            ...
            if (boxMode) {
              var canvas = document.getElementById('hacking');
              var ctx = canvas.getContext('2d');
              var rect = canvas.getBoundingClientRect();
                if (boxPointX !== "NONE") {
                  ctx.strokeStyle = 'black';
                  ctx.shadowBlur=0;
                  ctx.lineWidth = this.brushSizes;
                  if (boxPointY >= this.stage.mouseY) {
                    if (boxPointX >= this.stage.mouseX) {
                      ctx.strokeRect(this.stage.mouseX-2, this.stage.mouseY-2, boxPointX - this.stage.mouseX+2, boxPointY - this.stage.mouseY+2);
                      ctx.strokeRect(this.stage.mouseX-1, this.stage.mouseY-1, boxPointX - this.stage.mouseX+1, boxPointY - this.stage.mouseY+1);
                      ctx.strokeRect(this.stage.mouseX+1, this.stage.mouseY+1, boxPointX - this.stage.mouseX-1, boxPointY - this.stage.mouseY-1);
                      ctx.strokeRect(this.stage.mouseX+2, this.stage.mouseY+2, boxPointX - this.stage.mouseX-2, boxPointY - this.stage.mouseY-2);
                      ctx.strokeRect(this.stage.mouseX, this.stage.mouseY, boxPointX - this.stage.mouseX, boxPointY - this.stage.mouseY);
                    } else {
                      ctx.strokeRect(boxPointX, this.stage.mouseY, this.stage.mouseX - boxPointX, boxPointY - this.stage.mouseY);
                      ctx.strokeRect(boxPointX-1, this.stage.mouseY-1, this.stage.mouseX - boxPointX+1, boxPointY - this.stage.mouseY+1);
                      ctx.strokeRect(boxPointX-2, this.stage.mouseY-2, this.stage.mouseX - boxPointX+2, boxPointY - this.stage.mouseY+2);
                      ctx.strokeRect(boxPointX+1, this.stage.mouseY+1, this.stage.mouseX - boxPointX-1, boxPointY - this.stage.mouseY-1);
                      ctx.strokeRect(boxPointX+2, this.stage.mouseY+2, this.stage.mouseX - boxPointX-2, boxPointY - this.stage.mouseY-2);
                    }
                  } else {
                    if (boxPointX >= this.stage.mouseX) {
                      ctx.strokeRect(this.stage.mouseX, boxPointY, boxPointX - this.stage.mouseX, this.stage.mouseY - boxPointY);
                      ctx.strokeRect(this.stage.mouseX+1, boxPointY+1, boxPointX - this.stage.mouseX-1, this.stage.mouseY - boxPointY-1);
                      ctx.strokeRect(this.stage.mouseX+2, boxPointY+2, boxPointX - this.stage.mouseX-2, this.stage.mouseY - boxPointY-2);
                      ctx.strokeRect(this.stage.mouseX-1, boxPointY-1, boxPointX - this.stage.mouseX+1, this.stage.mouseY - boxPointY+1);
                      ctx.strokeRect(this.stage.mouseX-2, boxPointY-2, boxPointX - this.stage.mouseX+2, this.stage.mouseY - boxPointY+2);
                    } else {
                      ctx.strokeRect(boxPointX, boxPointY, this.stage.mouseX - boxPointX, this.stage.mouseY - boxPointY);
                      ctx.strokeRect(boxPointX-1, boxPointY-1, this.stage.mouseX - boxPointX+1, this.stage.mouseY - boxPointY+1);
                      ctx.strokeRect(boxPointX-2, boxPointY-2, this.stage.mouseX - boxPointX+2, this.stage.mouseY - boxPointY+2);
                      ctx.strokeRect(boxPointX+1, boxPointY+1, this.stage.mouseX - boxPointX-1, this.stage.mouseY - boxPointY-1);
                      ctx.strokeRect(boxPointX+2, boxPointY+2, this.stage.mouseX - boxPointX-2, this.stage.mouseY - boxPointY-2);
                    }
                  }
                  ...
                  boxPointX = this.stage.mouseX;
                  boxPointY = this.stage.mouseY;
                  this.removeMouseMove(this);
                  return;
                }
            }
            if (lineMode) {
              ...
              var rect = canvas.getBoundingClientRect();
                if (boxPointX !== "NONE") {
                  ...
                  ctx.lineWidth = this.brushSizes;
                  ctx.beginPath();
                  ctx.moveTo(boxPointX,boxPointY);
                  ctx.lineTo(this.stage.mouseX,this.stage.mouseY);
                  ctx.stroke();
                  boxPointX = "NONE";
                  boxPointY = "NONE";
                  this.removeMouseMove(this);
